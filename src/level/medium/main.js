...
(async () => {
    ...
    for (let i = 2; i <= 29; i++) {
        ...
        const numberOnPage = i.toString();

        // Parameters
        const text_file = `LeetCode-${levelOnTxt}-Page-${numberOnPage}.txt`;
        const target_link = `https://leetcode.com/problemset/all/?difficulty=${levelOnLink}&page=${numberOnPage}`;
